...
class RecordDef(ASTNode):
    """Record definition: ``record Name: type field ... end``.

    Record bodies use the same colon-delimited surface as functions/classes.
    """
    ...
    def __init__(
        ...
        self.field_defaults: dict[str, ASTNode] = field_defaults or {}
...
class ClassDef(ASTNode):
    ...
    Class bodies use the same colon-delimited surface as functions/records.
    """
