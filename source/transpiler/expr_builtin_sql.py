...
class ExprBuiltinSqlEmitter:
    ...
    def _builtin_sql_open(self, args):
        ...
        CompilationContext.require_feature("sqlite", "sql_open()")

        if len(args) != 1:
            raise ExprGenError("sql_open() expects filename")
        ...
        open_flags = ir.Constant(ir.IntType(32), 0x00000002 | 0x00000004 | 0x00000040)
