...
class ExprBuiltinMemoryEmitter:
    ...
    def _builtin_peek_generic(
        ...
        # peek8/peek16/peek32 expose raw *unsigned* bit patterns.  Recording
        # that fact is essential when the value later crosses a uN return or
        # assignment boundary (0xffffffff must not become signed -1).
        self.codegen.set_signedness(val, False)
        return val
