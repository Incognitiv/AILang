...
def compile_to_native(
    ...
    # DWARF !DIFile/!DISubprogram metadata records the actual source
    # path, which gdb/perf need to resolve line info back to AILang
    # source instead of "?".
    try:
    ...
    with open(source_file, "r", encoding="utf-8") as f:
        source_code = f.read()
    ir_code = compile_to_ir_fast(source_code, source_file=source_file)
