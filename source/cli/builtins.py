...
def _print_builtins():
    ...
    print("\n=== DEFINITIONS ===")
    defs = [
        "type name(args): ... end  - Explicit return type, e.g. int main():",
        "def name(args): ... end   - Infer return type from all value-return paths; no value return => void",
        "def name(args): rettype ... end  - Legacy postfix annotation (accepted, non-canonical)",
        "async def ... end  - Legacy async syntax (runtime semantics are limited)",
        "test name ... end  - Test function",
        "record Name: fields end  - Canonical record body",
        "class Name: fields/methods end  - Canonical class body",
