...
def test_optimizer_report_records_stack_and_virtual_decisions() -> None:
    ...
    # Method inlining is intentionally disabled during the correctness-first
    # phase because the old path could bypass typed argument/return checks.
    assert summary.get("method_inline:inlined", 0) == 0
